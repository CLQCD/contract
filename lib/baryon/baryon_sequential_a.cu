...
namespace baryon_sequential
{
  ...
  {
    return reinterpret_cast<void *>(baryon_sequential_a_kernel<CONTRACT, GAMMA_FC>);
  }
  ...
  template void launch<AD_BE_CF, PRESERVE_A>(void *correl, void *propag_a, void *propag_b, void *propag_c,
                                             size_t volume, int gamma_ab, int gamma_de, int gamma_fc);
  template void launch<AD_BF_CE, PRESERVE_A>(void *correl, void *propag_a, void *propag_b, void *propag_c,
                                             size_t volume, int gamma_ab, int gamma_de, int gamma_fc);
  template void launch<AE_BD_CF, PRESERVE_A>(void *correl, void *propag_a, void *propag_b, void *propag_c,
                                             size_t volume, int gamma_ab, int gamma_de, int gamma_fc);
  template void launch<AE_BF_CD, PRESERVE_A>(void *correl, void *propag_a, void *propag_b, void *propag_c,
                                             size_t volume, int gamma_ab, int gamma_de, int gamma_fc);
  template void launch<AF_BD_CE, PRESERVE_A>(void *correl, void *propag_a, void *propag_b, void *propag_c,
                                             size_t volume, int gamma_ab, int gamma_de, int gamma_fc);
  template void launch<AF_BE_CD, PRESERVE_A>(void *correl, void *propag_a, void *propag_b, void *propag_c,
                                             size_t volume, int gamma_ab, int gamma_de, int gamma_fc);
} // namespace baryon_sequential